...
import { Icon, Screen } from '@encryption/src/ui/components/layout/Screen';
...
ChoicesStory.args = {
  ...
  actions: (
    <>
      <Button variant="secondary" icon={<Icon name="laptop" />}>
        Use another device
      </Button>
      <Button variant="tertiary" icon={<Icon name="key" />}>
