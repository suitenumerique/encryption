...
import { Icon, type IllustrationName, Screen } from '@encryption/src/ui/components/layout/Screen';
...
export function RecoveryKitBackup({
  ...
  const cancelButton = onCancel && (
    <Button variant="tertiary" color="neutral" onClick={onCancel} disabled={isBusy} fullWidth>
    ...
    return (
      ...
      >
        ...
        <Button
          ...
          icon={<Icon name={isCopied ? 'check' : 'content_copy'} />}
        >
  ...
  return (
    ...
    >
      <div className="enc-actions">
        ...
        <Button variant="bordered" onClick={handleSaveFile} icon={<Icon name="download" />}>
          {t('onboarding.btn_save_file')}
        </Button>
        <Button variant="bordered" onClick={handlePrint} icon={<Icon name="print" />}>
