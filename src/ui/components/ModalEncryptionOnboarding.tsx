...
export function ModalEncryptionOnboarding({
  ...
  //
  // The `version` must be exactly (current active version + 1). Two devices
  // can race for the same next version, so on a version/concurrency conflict
  // we refetch and retry with a freshly signed record.
