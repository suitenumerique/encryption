...
function LastResortStep({
  ...
  return (
    <Screen
      ...
      actions={
        <>
          <Button variant="bordered" color="neutral" onClick={onBack} disabled={isPending}>
    ...
    >
      ...
      {hasFingerprint && (
        <div>
          <label className="enc-label" htmlFor="onboarding-confirm-fingerprint">
...
export function ModalEncryptionOnboarding({
  ...
  const anotherDeviceButton = onUseAnotherDevice && (
    <Button variant="tertiary" onClick={onUseAnotherDevice} icon={<Icon name="laptop" />}>
    ...
    <>
      ...
      {step === 'existing-key-choice' && (
        <Screen
          ...
          actions={
            <>
              {onUseAnotherDevice && (
                <Button variant="secondary" onClick={onUseAnotherDevice} icon={<Icon name="laptop" />}>
                  {t('onboarding.btn_use_another_device')}
                </Button>
              )}
              <Button variant={onUseAnotherDevice ? 'tertiary' : 'secondary'} onClick={() => setStep('restore')} icon={<Icon name="key" />}>
      ...
      {step === 'previous-identity' && (
        <Screen
          ...
          actions={
            <>
              <Button variant="secondary" onClick={() => setStep('restore')} icon={<Icon name="key" />}>
                {t('onboarding.btn_restore_from_backup')}
              </Button>
              {anotherDeviceButton}
